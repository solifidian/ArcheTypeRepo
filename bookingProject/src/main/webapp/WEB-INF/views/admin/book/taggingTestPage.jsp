...
<%@ taglib prefix="tag" uri="/WEB-INF/tld/custom_tag.tld" %>
  ...
  <body>
            ...
            <div class="well">
         	 <form id="bookEditForm">
				...
				<div class="row form-group col-md-8">
					<label for="tagbox">고객이 추가한 태그들</label>
					<div class="panel panel-default" id="tagbox">
						<button type="button" class="btn btn-info btn-sm" id="tagBtn" data-num="1"
						...
						' >
							태그1&nbsp;<span class="badge">4</span>
						</button>
						<button type="button" class="btn btn-info btn-sm" id="tagBtn" data-num="2"
						data-container="body" data-toggle="popover" data-placement="top" data-html="true"
						data-content='
							<button type="button" class="btn btn-success btn-sm">
								<span class="glyphicon glyphicon-thumbs-up"></span>
						...
						' >
							태그2&nbsp;<span class="badge">12</span>
						</button>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-md-8">
						<label for="b_comment">태그 추가</label>
    ...
    <script src="/resources/include/js/tooltip.js"></script>
