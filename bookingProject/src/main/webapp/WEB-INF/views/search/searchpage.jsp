<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
		...
		<div class="well">
	          	<!-- 전체 리스트 제어 폼 -->
	          	<form class="navbar navbar-left" id="searchForm" method="get" action="/book/bookSearch.do">
		...
		<div class="col-md-8 col-md-offset-4">
	        ...
	        <div class="col-md-7 col-md-offset-5">
	      		<div class="col-md-2">
	      		<button  class="btn btn-default btn-xs" aria-label="Left Align"><span class="glyphicon glyphicon-chevron-left"></span></button> 
	      		</div>
	      	<div class="col-md-4">
	      		...
	      		<div class="col-md-1">
	      		<button  class="btn btn-default btn-xs" aria-label="Left Align"><span class="glyphicon glyphicon-chevron-right"></span></button> 
	      		</div>
					...
					<div class="features_items"><!--features_items-->
						...
						<c:forEach var="d" items="${data}">							
							<tr data-num="${d.isbn}">
							  ...
							  <span class="godetail"><h3>${d.b_title}</h3></span>
								 <span> ${d.b_author}지음 ${d.b_translator} 옮김 북스토리라이프 ${d.b_pubdate}</span><br>
