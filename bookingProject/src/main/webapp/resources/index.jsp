...
<link href="/resources/include/css/font-awesome.min.css"
	rel="stylesheet">
				...
				<div class="col-sm-10">
				 ...
				 <div class="col-sm-5 col-md-offset-2">
					<input type="button" class="btn btn-default btn-lg"
						value="쿠폰 받으러 가기" id="goMemberJoinBtn" /> <input type="button"
						class="btn btn-default btn-lg" value="홈페이지 가기" id="goHomeBtn" />
				 ...
				 <div class="col-sm-12 col-md-offset-2">
				    	<div id="fb-root">
					   	...
					   	<div class="fb-comments"
						   	data-href="https://www.facebook.com/greatbookbooking/"
							data-numposts="5">
						</div>
					</div>
				</div>
